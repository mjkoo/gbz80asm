...
const char *mnemonics[] = {
    "call", "halt", "push", "reti", "rlca", "rrca", "defb", "defw", "defs",
    "defm", "adc", "add", "and", "bit", "ccf", "cpl", "daa", "dec", "equ", "inc",
    "ldd", "ldi", "nop", "pop", "res", "ret", "rla", "rlc", "rra", "rrc", "rst",
    "sbc", "scf", "set", "sla", "sll", "sra", "srl", "sub", "xor", "org", "cp",
    "di", "ei", "jp", "jr", "ld", "or", "rl", "rr", "db", "dw", "ds", "dm",
...
main (int argc, char **argv)
{
    ...
    add_include ("/usr/share/gbz80asm/headers/");
