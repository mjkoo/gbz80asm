/* GBZ80 assembler by shevek

   Copyright (C) 2002-2007 Bas Wijnen <shevek@fmf.nl>
   Copyright (C) 2005 Jan Wilmans <jw@dds.nl>
   Copyright (C) 2014 Maxwell J. Koo <mjkoo90@gmail.com>

   This file is part of gbz80asm.

   GBZ80asm is free software; you can redistribute it and/or modify
   it under the terms of the GNU General Public License as published by
   the Free Software Foundation; either version 3 of the License, or
   (at your option) any later version.

   GBZ80asm is distributed in the hope that it will be useful,
...
enum mnemonic
{
    CALL, HALT, PUSH, RETI, RLCA, RRCA, DEFB, DEFW, DEFS, DEFM, ADC, ADD, AND,
    BIT, CCF, CPL, DAA, DEC, EQU, INC, LDD, LDI, NOP, POP, RES, RET, RLA, RLC,
    RRA, RRC, RST, SBC, SCF, SET, SLA, SLL, SRA, SRL, SUB, XOR, ORG, CP, DI, EI,
    JP, JR, LD, OR, RL, RR, DB, DW, DS, DM, INCLUDE, INCBIN, IF, ELSE, ENDIF,
    END, MACRO, ENDM, SEEK
};
